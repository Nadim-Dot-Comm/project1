...
'''
For bonus mark #5, uncomment lines 104, 143, 147, 173, 183 for the amount to show on the interface.
                (click on line # then press alt 4 to uncomment)

For bonus mark #6 see line 201 to see how it shows on the interface.
